...
#define DEBUG( ... )                                                                                                   \
	...
	if( telnetClient.connected() )                                                                                       \
		telnetClient.printf( __VA_ARGS__ );
...
// ./esptool.py --port /dev/tty.usbserial --baud 460800 write_flash --flash_size=8m 0
// /var/folders/yh/bv744591099f3x24xbkc22zw0000gn/T/build006b1a55228a1b90dda210fcddb62452.tmp/test.ino.bin FlashSize 1M
// (128k SPIFFS) C:\Python27\python.exe "C:\Program Files\esptool\espota.py" --ip=192.168.178.95 --port=8266 --progress
// --file=${workspace_loc}\${project_path}\Release\${project_name}.bin
